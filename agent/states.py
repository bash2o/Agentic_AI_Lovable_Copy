...
class File(BaseModel):
    path: str = Field(description="To path to the file to be created or modified")
    purpose: str = Field(
...
class Plan(BaseModel):
    ...
    description : str = Field(
        description="The oneline description of the app to be built, e.g. 'A web application for managing personal finances'")
